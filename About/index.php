...
<html lang="zh-CN"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
<?php
$numLeetCode=0;$numLintCode=0;
require_once('../functions/connect.php');
require_once('../functions/fun.search.php');
$skeywords='LeetCode';
$sql=sqlsearch($skeywords);
$query=mysqli_query($con,$sql);
$numLeetCode=mysqli_num_rows($query);

$skeywords='LintCode';
$sql=sqlsearch($skeywords);
$query=mysqli_query($con,$sql);
$numLintCode=mysqli_num_rows($query);
?>
<!--顶部导航栏-->
...
<section id="content">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8">
			<div class="aboutMeHead"><h2>关于</h2></div>
			<div class="aboutMeContent">
<p>www.ojcoder.cn 是一个提供OJ平台答案查询服务的网站，你可以在这里查询LeetCode、LintCode等常见OJ平台题目的答案！本站答案主要来源于网友贡献和本人自己平时的练习，如果你有更好的答案或者其他新的题目，欢迎向本站贡献代码。如果你对本站感兴趣，欢迎关注本站<strong>微信公众号：OJCoder</strong>。</p>
<p>本站当前收录LeetCode题目答案<strong> <?php  if($numLeetCode) echo $numLeetCode;else echo 'NULL' ?> </strong>道，LintCode题目答案<strong> <?php  if($numLintCode) echo $numLintCode;else echo 'NULL' ?> </strong>道。</p>
<p><strong>使用方法：</strong>可以直接输入<strong>题目编号</strong>或者<strong>标题</strong>来搜索答案，其中<strong>标题</strong>方式支持模糊查询。</p>
<p><strong>免责声明：</strong>本站内容仅供网友交流学习，其中来自网络的内容，版权归属原作者。如果您认为侵犯了您的版权，请来信告知，我将第一时间删除侵权内容。</p>

<p>可以通过 <a href="mailto:ojcoder@163.com">ojcoder@163.com</a> 这个邮箱与我联系。</p></div>
			</div>
			<div class="col-md-2"></div>
		</div>
	</div>
